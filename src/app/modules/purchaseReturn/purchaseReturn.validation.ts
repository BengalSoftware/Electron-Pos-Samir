...
const createPurchaseReturnZodSchema = z.object({
    body: z.object({
        ...
        purchaseNo: z.string({ required_error: "Purchase No is required" }),
...
const getPurchaseReturnZodSchema = z.object({
    name: z.string({
        required_error: "param is required"
    }),
});

export const PurchaseReturnValidation = {
