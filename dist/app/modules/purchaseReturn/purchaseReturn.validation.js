...
exports.PurchaseReturnValidation = void 0;
...
const createPurchaseReturnZodSchema = zod_1.default.object({
    body: zod_1.default.object({
        ...
        purchaseNo: zod_1.default.string({ required_error: "Purchase No is required" }),
...
const getPurchaseReturnZodSchema = zod_1.default.object({
    name: zod_1.default.string({
        required_error: "param is required"
    }),
});
exports.PurchaseReturnValidation = {
    getPurchaseReturnZodSchema,
    createPurchaseReturnZodSchema
};
