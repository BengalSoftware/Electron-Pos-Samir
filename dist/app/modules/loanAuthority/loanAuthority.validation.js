...
exports.LoanAuthorityValidation = void 0;
const zod_1 = __importDefault(require("zod"));
const createLoanAuthorityZodSchema = zod_1.default.object({
...
const getLoanAuthorityZodSchema = zod_1.default.object({
    name: zod_1.default.string({
        required_error: "Param is required"
    }),
});
exports.LoanAuthorityValidation = {
