...
const getSingleCategory = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield category_model_1.Category.findById(payload);
    return result;
});
const deleteCategory = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    yield category_model_1.Category.findByIdAndDelete(payload);
});
...
const updateCategory = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield category_model_1.Category.findOneAndUpdate({ _id: id }, { $set: Object.assign({}, payload) }, { new: true });
    return result;
});
